...
看完界面是不是很酷！**AnXray**发行有许多版本，兼容性非常好。对不清楚下载哪个版本的朋友可以 先看个究竟再决定，如下图目前发布最新的0.1-beta06版本.![EngAns_3.png](../assets/img/2022-02-01-anxray-proxy_imgs/OhejY3iKXI9q26V-16438054190111.png)
